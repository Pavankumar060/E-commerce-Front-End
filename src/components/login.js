...
const Login = () =>{
    ...
    return(
        ...
        <img src="https://www.onlinelogomaker.com/blog/wp-content/uploads/2017/06/shopping-online.jpg" alt="Logo" width={500}/>
    ...
    <form  onSubmit={handleSubmit(onFinalSubmit)}>
      ...
      <h6>Doesn't have an account? <a style={{color:"blue" }} href="/signup">Sign-up</a></h6>
    </form>
